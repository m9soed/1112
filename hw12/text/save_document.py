...
from PySide6.QtCore import QDate, Qt, QByteArray
...
class MainWindow(QMainWindow):
    ...
    def create_letter(self, name, address, orderItems, sendOffers):
        editor = QTextEdit() # QTextBrowser, QTextEdit
        ...
        writer = QTextDocumentWriter('out.odt')
        # writer.setFormat(QByteArray('odf'))
